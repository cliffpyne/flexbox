...
// ── NobleUI template pages (keep all for reference) ──────────────────────────
...
const NobleUIPlaceholder = lazy(() => import('@/pages/ui-components/placeholder/PlaceholderPage'));
      ...
      <Routes>
        ...
        <Route element={<AuthGuard />}>
          <Route element={<MainLayout />}>
            ...
            {/* NobleUI template routes — kept for reference/components */}
            ...
            <Route path="ui-components/placeholder" element={<NobleUIPlaceholder />} />
