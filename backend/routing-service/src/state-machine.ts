...
export const FLOW_STATE_MACHINE: Record<string, NextEventRule> = {
  ...
  'PARCEL_BOX_SEALED': {
    events: ['PARCEL_BOX_HANDED_TO_COURIER', 'PARCEL_LAST_MILE_RIDER_ASSIGNED', 'PARCEL_READY_FOR_SELF_PICKUP'],
    actors: [UserRole.OFFICE_WORKER, UserRole.OFFICE_MANAGER, UserRole.RIDER, UserRole.OPS_ADMIN, UserRole.SUPER_ADMIN, 'SYSTEM'],
  },
